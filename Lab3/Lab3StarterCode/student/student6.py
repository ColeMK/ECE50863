...
def student_entrypoint(client_message: ClientMessage):
	...
	if len(prediction_buffer) > 1:
		...
		lesser_options = [client_message.quality_bitrates[0]] + [option for option in client_message.quality_bitrates[1:] if option <= selected_bitrate]
		selected_bitrate = map_to_nearest_option(selected_bitrate, lesser_options)
